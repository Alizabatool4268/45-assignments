...
let quote: string =
  "Think a hundred times before you take a decision, but once that decisoion is taken, stand by it as one man. ";
...
let Amessage: string =
  "Nations are born in the hearts of poets ,they prosper and die in the hand of politicians";
...
let numThree: number = 10;
let numFour: number = 2;
console.log(numThree - numFour);

let numFive: number = 4;
let numSix: number = 2;
console.log(numFive * numSix);

let numSeven: number = 64;
let numEight: number = 8;
...
let authorA: string = "Quaid-e-azam";
let quoteA: string =
  "Think a hundred times before you take a decision, but once that decisoion is taken, stand by it as one man. ";
...
let names: string[] = ["laiba", "kainat", "emaan"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
...
let namesA: string[] = ["laiba", "kainat", "emaan"];
...
const transport: string[] = ["Honda motorcycle", "Rollsroyce car", "Yatch"];
...
console.log(
  `"Asalam alikum ${guests[0]} hope your free tonight.Iam hosting a dinner tonight and you are invited"`
);
console.log(
  `"Asalam alikum ${guests[1]} hope your free tonight.Iam hosting a dinner tonight and you are invited"`
);
console.log(
  `"Asalam alikum ${guests[2]} hope your free tonight.Iam hosting a dinner tonight and you are invited"`
);
...
console.log(
  "hey guys! I found a bigger table theirfore, I am extending the guest list by the slighest so there are gonna be more guests"
);
guests.unshift("ali");
...
guests.forEach((guests) => {
  console.log(
    `Assalam alikum! Dear ${guests} you are invited for dinner tonight. At my place.`
  );
});
// //ASSIGNMENT NO 17

console.log(
  "sad news! the bigger tables would not be able to arrive in time. thats why I can only invite two guests"
);
guests.pop();
console.log(guests);
...
let places: string[] = ["Iran", "Paris", "korea", "America", "Dubai"];
...
console.log("original order is changed to alphabetical order", places);
console.log("reverse permanent  alphabetical order", places.reverse());

//ASSIGNMENT NO 19

let guest: string[] = ["laiba", "kainat", "fatima"];
let guestNumber: number = guest.length;
console.log(` the number of guests I called was ${guestNumber}`);

//ASSIGNMENT NO 20

let list: string[] = ["mount everest", "america", "canada", "Iran", "paris"];
console.log(list);
...
//0         //1          //2
let makeup: string[] = ["lipstick", "eyeshadow", "eyeliner"];
...
let alien_color4: string = "purple";
...
let pizza: string[] = ["chiken tikka", "margherita", "fajita"];
for (let i = 0; i < pizza.length; i++) {
  console.log(`I like ${pizza[i]} pizza`);
}
console.log(
  "chiken tikka, margherita ,fajita pizza is really delicious.I can eat it all day.I really love pizza"
);
...
function makeShirt(size: string, message: string) {
  return console.log(
    `size of the shirt is ${size} message on the shirt is ${message}`
  );
}
...
function city_country(cityCountryPair: string) {
...
function make_albums(Artistname: string, album: string, track?: number) {
  let albums: { Artistname: string; album: string; track?: number } = {
...
function sandwishes(item: string[]) {
...
function makingCars(manufacturer: string, model: string, ...option: [string, string][]) {
  let car: Cars = { manufacturer, model };
...
console.log( makingCars("Nissan", "Nissan GT-R", ["color", "Black"], ["year", "2017"]));
console.log(makingCars("Honda", "Cvic", ["color", "Blue"], ["year", "2000"]));
